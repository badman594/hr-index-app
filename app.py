...
# Вкладка 1: Готовая аналитика рынка (на базе статьи Forbes)
st.header("📈 Текущая ситуация по ключевым направлениям (РФ)")

# Базовые данные
initial_data = {
    "Профессия": ["Юрист (Первичный аудит)", "Тестировщик ПО (Junior QA)", "Копирайтер / Контент-менеджер", "Специалист по Информ. Безопасности", "AI Engineer / Data Scientist"],
    "Вакансии":,
    "Резюме новичков":,
    "Выпускники Вузов (План)": [300, 300, 250, 200, 195]
}
